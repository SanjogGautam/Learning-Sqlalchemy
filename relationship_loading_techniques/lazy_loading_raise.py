...
from sqlalchemy.orm import DeclarativeBase, relationship, sessionmaker, Mapped, mapped_column,joinedload
from typing import Optional

db_url = "sqlite:///raise.db"
...
class User(base):
    ...
    latest_post: Mapped[Optional["Posts"]] = relationship('Posts', uselist=False, lazy='raise')
...
# Execution
users = session.query(User).options(joinedload(User.latest_post)).all()
